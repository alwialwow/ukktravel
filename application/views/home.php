...
<!-- Mirrored from www.template-preview.com/bootstrap-templates/Travel-agency/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jan 2018 13:55:19 GMT -->
<head>
...
<link rel="stylesheet" href="<?php echo base_url('assets/AirBooking/css/bootstrap.css') ?>">
<link rel="stylesheet" href="<?php echo base_url('assets/AirBooking/css/font-awesome.css') ?>">
<link rel="stylesheet" href="<?php echo base_url('assets/AirBooking/css/animate.css') ?>">
<link rel="stylesheet" href="<?php echo base_url('assets/AirBooking/css/select2.css') ?>">
<link rel="stylesheet" href="<?php echo base_url('assets/AirBooking/css/smoothness/jquery-ui-1.10.0.custom.css') ?>">
<link rel="stylesheet" href="<?php echo base_url('assets/AirBooking/css/style.css') ?>">

<script src="<?php echo base_url('assets/AirBooking/js/jquery.js') ?>"></script>
<script src="<?php echo base_url('assets/AirBooking/js/jquery-ui.js') ?>"></script>
<script src="<?php echo base_url('assets/AirBooking/js/jquery-migrate-1.2.1.min.js') ?>"></script>
<script src="<?php echo base_url('assets/AirBooking/js/jquery.easing.1.3.js') ?>"></script>
<script src="<?php echo base_url('assets/AirBooking/js/superfish.js') ?>"></script>

<script src="<?php echo base_url('assets/AirBooking/js/select2.js') ?>"></script>

<script src="<?php echo base_url('assets/AirBooking/js/jquery.parallax-1.1.3.resize.js') ?>"></script>

<script src="<?php echo base_url('assets/AirBooking/js/SmoothScroll.js') ?>"></script>

<script src="<?php echo base_url('assets/AirBooking/js/jquery.appear.js') ?>"></script>

<script src="<?php echo base_url('assets/AirBooking/js/jquery.caroufredsel.js') ?>"></script>
<script src="<?php echo base_url('assets/AirBooking/js/jquery.touchSwipe.min.js') ?>"></script>

<script src="<?php echo base_url('assets/AirBooking/js/jquery.ui.totop.js') ?>"></script>

<script src="<?php echo base_url('assets/AirBooking/js/script.js') ?>"></script>
      ...
      <div class="navbar navbar_ navbar-default">
        ...
        <div class="navbar-collapse navbar-collapse_ collapse">
          <ul class="nav navbar-nav sf-menu clearfix">
            ...
            <li><a href="index.php/home/login">Log In</a></li>
          </ul>
        </div>
      </div>
    </div>
...
<script src="<?php echo base_url('assets/AirBooking/js/bootstrap.min.js') ?>"></script>
</body>

<!-- Mirrored from www.template-preview.com/bootstrap-templates/Travel-agency/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Jan 2018 13:59:20 GMT -->
</html>