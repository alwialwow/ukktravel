      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url('index.php/admin/tambah') ?>"><i class="fa fa-circle-o"></i> Tambah</a></li>
            <li><a href="<?php echo base_url('#') ?>"><i class="fa fa-circle-o"></i>Daftar</a></li>
          </ul>
        </li>
